...
describe('Suíte de Testes Fraca para 50 Operações Aritméticas', () => {
  ...
  test('33c. deve retornar false para 0', () => { expect(isPrimo(0)).toBe(false); });
  test('33d. deve retornar false para 1', () => { expect(isPrimo(1)).toBe(false); });
  test('33e. deve retornar true para 2', () => { expect(isPrimo(2)).toBe(true); });
  ...
  test('36b. deve retornar min quando valor ESTRITAMENTE menor que min', () => { 
  ...
  test('36f. deve retornar valor quando ESTRITAMENTE entre min e max', () => { 
  ...
  test('38b. deve converter 100°C corretamente', () => { expect(celsiusParaFahrenheit(100)).toBe(212); });
  test('39. deve converter Fahrenheit para Celsius', () => { expect(fahrenheitParaCelsius(32)).toBe(0); });
  test('39b. deve converter 212°F corretamente', () => { expect(fahrenheitParaCelsius(212)).toBe(100); });
  ...
  test('44b. deve retornar false quando números iguais em isMaiorQue', () => { expect(isMaiorQue(5, 5)).toBe(false); });
  test('44c. deve retornar false quando primeiro é menor', () => { expect(isMaiorQue(5, 10)).toBe(false); });
  test('45. deve verificar se um número é menor que outro', () => { expect(isMenorQue(5, 10)).toBe(true); });
  test('45b. deve retornar false quando números iguais em isMenorQue', () => { expect(isMenorQue(5, 5)).toBe(false); });
  test('45c. deve retornar false quando primeiro é maior', () => { expect(isMenorQue(10, 5)).toBe(false); });
  test('46. deve verificar se dois números são iguais', () => { expect(isEqual(7, 7)).toBe(true); });
  test('46b. deve retornar false quando números diferentes', () => { expect(isEqual(7, 8)).toBe(false); });
  ...
  test('47e. deve calcular a mediana de array par desordenado', () => { expect(medianaArray([4, 2, 1, 3])).toBe(2.5); });
  test('47f. deve calcular a mediana com números negativos', () => { expect(medianaArray([-5, -1, 0, 3])).toBe(-0.5); });
